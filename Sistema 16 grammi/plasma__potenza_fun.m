function P_t_vect = plasma_potenza_fun(nz1,nz2,nz3,Te_t,Te_u,qq_t,nodi)
...
P_t_vect = qqfun_vett(Te_t,Te_u,qq_t);
return
...
if flag_det == 0
    ...
    Tet = 1;
    qqt = 0;  % da cambiare se vogio mettere il cono, da cambiare anche la distribuzione della potenza sotto
end
